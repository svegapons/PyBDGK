...
class GE_ClustBased_PercCompleteness(GE_Base):
    """
    ...
    def encode(self, interm_rep, clust_alg='MiniBatchKMeans',
        ...
        n_clusters: int
            Number of clusters to be computed. If n_clusters = -1 then
            n/clust_ratio is used.
        ...
        completeness: float [0, 1]
            Percentage of completeness we want in the resulting
        ...
        **kwds: optional parameters for the similarity measure.
        ...
        #Computing the threshold according to the percentage of completeness
